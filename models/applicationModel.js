...
const applicationSchema = new mongoose.Schema(
  {
      ...
      residencies: [
        {
          ...
          residency1Completed: { type: String },
        },
        {
          ...
          residency2Completed: { type: String },
        },
        {
          ...
          residency3Completed: { type: String },
        },
      ],
      medicalLicenses: [
        {
    ...
    organizationApplication: { type: mongoose.Schema.Types.ObjectId, ref: 'CredentialingApplication', required: true },
    status: {
      type: String,

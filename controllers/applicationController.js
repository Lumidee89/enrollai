...
const createApplication = async (req, res) => {
  try {
    const { applicationType, step1, step2 } = req.body;
...
module.exports = { createApplication, getApplicationById, getApplicationsByUserId, updateApplication, deleteApplication, getAllApplications, updateApplicationStatus };